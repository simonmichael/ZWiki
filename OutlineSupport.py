...
class PersistentOutline(Outline.Outline, SimpleItem):
    ...
    # causing problems for the ATCT migrator in plone 2.1rc<3. To avoid it,
    # allow them to be overwritten without complaint.  Maybe drop this later
    # though, the outline cache can contain valuable ordering information ?
